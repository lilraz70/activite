<div >
    <div class="h-full card">
        <div class="card-header">
            <h4 class="card-title
            dark:text-slate-300">Liste des mesures du risque</h4>
        </div>
...
border-slate-100 dark:border-slate-700 rounded-t-md">
                ...
                items-center rtl:space-x-reverse">
                            ...
                            <p class="truncate">
                                <span class="text-sm text-slate-600 dark:text-slate-300 font-normal">
                                    <a wire:click="show('{{ $measure->id }}')"> {{ $measure->name }}</a>
                                ...
                                <div>
                                    <div class="dropstart relative">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                <button wire:click="openModal('{{ $measure->id }}')"
                    ...
                    w-full border-b border-b-gray-500 border-opacity-10 px-4 py-2 text-sm dark:text-slate-300  last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex space-x-2 items-center capitalize  rtl:space-x-reverse">
                                            ...
                                            <li>
                                                <button
                                                    wire:click="confirmDelete('{{ $measure->name }}', '{{ $measure->id }}')"
                    ...
                    -center justify-center h-full">
                            <div class="text-center">
                                <p class="text-slate
                        dark:text-slate-300">Aucune mesure trouvé
                                </p>
                            </div>
                        </li>
                    @endforelse
    ...
    <x-form-modal class="form-modal-0">
        <x-slot name="title">
            {{ $isUpdate ? 'Modification de la mesure ' . $name : "Ajout d'une nouvelle mesure" }}
        </x-slot>
        <x-slot name="body">
                    ...
                    <div class="input-area">
                        <div class="relative">
                            ...
                            <input wire:model='name' type="text" class="form-control pr-9"
                                placeholder="Veuillez renseigner le nom du mesure">
                            @error('name')
                                <span
