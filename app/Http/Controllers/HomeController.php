...
class HomeController extends Controller
{
    ...
    {
        $numberOfActivity = Activity::count();
        $numberOfTask = Task::count();
        $numberOfRisk = Risk::count();
        $numberOfMeasure = Measure::count();
        $numberOfCollaborator = Collaborator::count();
        return view('dashboards.analytic', [
            'pageTitle' => 'Tableau de bord ',
            'numberOfActivity' => $numberOfActivity,
            'numberOfTask' => $numberOfTask,
            'numberOfRisk' => $numberOfRisk,
            'numberOfMeasure' => $numberOfMeasure,
            'numberOfCollaborator' => $numberOfCollaborator,
        ]);
    }
